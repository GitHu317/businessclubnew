...
function StatCard({ label, value, icon: Icon, tone }) {
  return <div className="card p-4 flex items-center gap-3"><div className={`w-10 h-10 rounded-xl flex items-center justify-center ${tone}`}><Icon className="w-5 h-5" /></div><div className="min-w-0"><div className="text-2xl font-bold text-brand-950">{value}</div><div className="text-sm text-slate-500 whitespace-normal">{label}</div></div></div>;
}
